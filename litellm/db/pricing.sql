...
BEGIN
    ...
    INSERT INTO token_prices (model_id, token_type, is_prompt, base_rate) VALUES
        (_gm_id, 'cache_read', true, 3.0e-07),
        (_gm_id, 'input', true, 2.0e-06),
        (_gm_id, 'output', false, 6.0e-06)
    ON CONFLICT (model_id, token_type, is_prompt) DO UPDATE SET base_rate = EXCLUDED.base_rate;
    ...
    INSERT INTO token_prices (model_id, token_type, is_prompt, base_rate) VALUES
        (_gm_id, 'cache_read', true, 2.0e-08),
        (_gm_id, 'cache_write', true, 1.0e-07),
    ...
    INSERT INTO token_prices (model_id, token_type, is_prompt, base_rate) VALUES
        (_gm_id, 'cache_read', true, 2.6e-07),
    ...
    INSERT INTO token_prices (model_id, token_type, is_prompt, base_rate) VALUES
        (_gm_id, 'cache_read', true, 1.9e-07),
    ...
    INSERT INTO token_prices (model_id, token_type, is_prompt, base_rate) VALUES
        (_gm_id, 'cache_read', true, 1.6e-07),
    ...
    INSERT INTO token_prices (model_id, token_type, is_prompt, base_rate) VALUES
        (_gm_id, 'cache_read', true, 6.0e-08),
    ...
    INSERT INTO token_prices (model_id, token_type, is_prompt, base_rate) VALUES
        (_gm_id, 'cache_read', true, 2.5e-07),
        (_gm_id, 'cache_write', true, 2.0e-06),
        (_gm_id, 'input', true, 2.0e-06),
        (_gm_id, 'output', false, 6.0e-06)
    ON CONFLICT (model_id, token_type, is_prompt) DO UPDATE SET base_rate = EXCLUDED.base_rate;
    ...
    INSERT INTO token_prices (model_id, token_type, is_prompt, base_rate) VALUES
        (_gm_id, 'cache_read', true, 5.0e-07),
        (_gm_id, 'cache_write', true, 1.475e-06),
    ...
    INSERT INTO token_prices (model_id, token_type, is_prompt, base_rate) VALUES
        (_gm_id, 'cache_read', true, 4.0e-08),
        (_gm_id, 'cache_write', true, 3.2e-07),
    ...
    INSERT INTO token_prices (model_id, token_type, is_prompt, base_rate) VALUES
        (_gm_id, 'cache_read', true, 5.0e-08),
        (_gm_id, 'cache_write', true, 3.25e-07),
